...
const file_proto_product_product_proto_rawDesc = "" +
	...
	"\bproducts\x18\x01 \x03(\v2\x1b.product.GetProductResponseR\bproducts\x12\x14\n" +
	...
	"\x0fremaining_stock\x18\x02 \x01(\x05R\x0eremainingStock\"x\n" +
	...
	"\x05price\x18\x03 \x01(\x01R\x05price\x12\x14\n" +
	"\x05stock\x18\x04 \x01(\x05R\x05stock2\xbe\x02\n" +
	...
	"\vDeductStock\x12\x1b.product.DeductStockRequest\x1a\x1c.product.DeductStockResponse\x12N\n" +
	"\rCreateProduct\x12\x1d.product.CreateProductRequest\x1a\x1e.product.CreateProductResponseB*Z(github.com/jason/ecommerce/proto/productb\x06proto3"
...
var file_proto_product_product_proto_goTypes = []any{
	...
	(*DeductStockRequest)(nil),    // 4: product.DeductStockRequest
	(*DeductStockResponse)(nil),   // 5: product.DeductStockResponse
...
var file_proto_product_product_proto_depIdxs = []int32{
	...
	4, // 3: product.ProductService.DeductStock:input_type -> product.DeductStockRequest
	...
	5, // 7: product.ProductService.DeductStock:output_type -> product.DeductStockResponse
	7, // 8: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
