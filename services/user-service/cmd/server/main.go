...
import (
	...
	"github.com/jason/ecommerce/user-service/internal/handler"
...
func main() {
	...
	if dsn == "" {
		dsn = "user:password@tcp(localhost:3306)/userdb?parseTime=true"
	}
	...
	grpcHandler := handler.NewUserGRPCHandler(svc)
